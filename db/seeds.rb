...
ludo = User.create!(name: 'Ludo', email: 'ludo@frozen.com', password: 'ludofrozen')
...
ludo.save!
neven = User.create!(name: 'Neven', email: 'neven@frozen.com', password: 'nevenfrozen')
neven.avatar = 'https://swordshield.pokemon.com/assets/img/articles/pokemon_yamper_2x.png'
neven.save!
caro = User.create!(name: 'Caro', email: 'caro@frozen.com', password: 'carofrozen')
caro.avatar = 'https://static.independent.co.uk/s3fs-public/thumbnails/image/2018/11/13/14/pokemon-lets-go.jpg?w968h681'
caro.save!
faten = User.create!(name: 'Faten', email: 'faten@frozen.com', password: 'fatenfrozen')
...
a = Equipment.create!(owner: User.all.sample, title: "Moonboots taille 40", material_category: "Boots", location: "Angers", price_per_day: "10",details: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
